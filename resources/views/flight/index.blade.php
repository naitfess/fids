                    ...
                    <div class="d-flex gap-2">
                        ...
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="{{ route('flight.create', ['flight_type' => 'arrival']) }}">Arrival</a></li>
                                <li><a class="dropdown-item" href="{{ route('flight.create', ['flight_type' => 'departure']) }}">Departure</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                changeStatusButtons.forEach(btn => {
                    btn.addEventListener('click', function() {
                        ...
                        const actionUrl = "{{ route('flight.changeStatus', ['flightId' => ':id']) }}"
                            .replace(':id', flightId);
